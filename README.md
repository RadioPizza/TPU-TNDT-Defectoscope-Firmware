...
- Отладочная плата ESP32-S3-DevKitC-1
...
- LED-подсветка рабочей области: один или несколько белых светодиодов мощность 200 мВт. Номинальный ток 20 мА при напряжении 3 В. Управляются транзисторной оптопарой (оптопара не имеет токов утечки и не чувствительна к наводкам).
  - Пин подключения: 37 - земля (цифровая), 36 - сигнальный.
